...
const NavbarItems = [
  { children: "Home", href: "/" },
  { children: "School Life", href: "/about" },
  { children: "Academics", href: "/academics" },
  { children: "Admission", href: "/admission" },
...
export const Navbar = () => {
  ...
  return (
    <nav className="h-20 flex border-b justify-between font-medium bg-green-800 w-full">
      <Link
        href="/"
        className={cn(
      ...
      <div className="hidden lg:flex">
        ...
        <Button
          asChild
          variant="secondary"
          className="bg-yellow-500 rounded-none border-l border-t-0 border-b-0 border-r-0 px-12 h-full hover:bg-white transition-colors text-lg duration-300 ease-in-out"
        >
